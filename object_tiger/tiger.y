...
%type <dec>    	    dec tydecs fundecs clsdecs
%type <ty>     	    ty
%type <declist>     decs
...
clsdecs: clsdec clsdecs {$$=A_FunctionDec(EM_tokPos,A_FundecList($1,$2->u.function));}   
   |		clsdec {$$=A_FunctionDec(EM_tokPos,A_FundecList($1,$2->u.function));}
   ;
